...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> create(ItemRequestDtoRequest request) {
    ...
    public ResponseEntity<Object> get(long ownerId, long requestId) {
        return get("/" + ownerId, requestId);
    }
}
